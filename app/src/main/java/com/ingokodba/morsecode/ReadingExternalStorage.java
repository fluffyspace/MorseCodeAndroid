...
public class ReadingExternalStorage extends Activity {
    EditText inputText;
    TextView response;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.read_external_storage_layout);
        ...
        if (!isExternalStorageAvailable() || isExternalStorageReadOnly()) {
            ...
            {
                Log.d("Files", "FileName:" + file[i].getName() + " " + file[i].getAbsolutePath());
            }
        }
